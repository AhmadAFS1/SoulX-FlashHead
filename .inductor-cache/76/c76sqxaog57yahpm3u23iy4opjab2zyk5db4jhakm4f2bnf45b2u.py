...
#   x => cat
# Graph fragment:
#   %cat : [num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%arg1_1, %arg2_1], 1), kwargs = {})
...
def call(args):
    ...
    assert_size_stride(arg2_1, (1, 128, 5, 26, 15), (249600, 1950, 390, 15, 1))
    assert_size_stride(arg3_1, (1536, 256, 1, 1, 1), (256, 1, 1, 1, 1))
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        triton_poi_fused_cat_0.run(arg1_1, arg2_1, buf0, 499200, stream=stream0)
        del arg1_1
        del arg2_1
        # Topologically Sorted Source Nodes: [x, x_1], Original ATen: [aten.cat, aten.convolution]
        buf1 = extern_kernels.convolution(buf0, arg3_1, stride=(1, 1, 1), padding=(0, 0, 0), dilation=(1, 1, 1), transposed=False, output_padding=(0, 0, 0), groups=1, bias=None)
        ...
        # Topologically Sorted Source Nodes: [x_2], Original ATen: [aten.clone]
        stream0 = get_raw_stream(0)
        triton_poi_fused_clone_1.run(buf1, arg4_1, buf2, 1950, 1536, stream=stream0)
        del arg4_1
        del buf1
    # Topologically Sorted Source Nodes: [to], Original ATen: [aten._to_copy]
    buf3 = torch.ops.prims.device_put.default(arg0_1, device(type='cuda', index=0))
    del arg0_1
    with torch.cuda._DeviceGuard(0):
        torch.cuda.set_device(0)
        buf4 = buf3
        assert_size_stride(buf4, (1024, 64), (64, 1))
        del buf3
    return (buf2, buf4, )
...
def benchmark_compiled_module(times=10, repeat=10):
    ...
    arg0_1 = rand_strided((1024, 64), (64, 1), device='cpu', dtype=torch.complex128)
    arg1_1 = rand_strided((1, 128, 5, 26, 15), (249600, 1950, 390, 15, 1), device='cuda:0', dtype=torch.bfloat16)
    arg2_1 = rand_strided((1, 128, 5, 26, 15), (249600, 1950, 390, 15, 1), device='cuda:0', dtype=torch.bfloat16)
    arg3_1 = rand_strided((1536, 256, 1, 1, 1), (256, 1, 1, 1, 1), device='cuda:0', dtype=torch.bfloat16)
