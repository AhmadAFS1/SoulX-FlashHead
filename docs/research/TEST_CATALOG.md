...
September 17 shoulder-visible source-detail replication: [exact earlier 1.25× portrait at 1280/640/320/256/128/64 nominal widths](../../benchmarks/portrait_source_detail_20260917/README.md). Six fresh INT8-storage/BF16-compute, four-step, 320×576/25-FPS runs on RTX 4070 SUPER, 12,282 MiB, driver 595.84, Torch 2.7.1+cu128/CUDA 12.8. All 1,500 frames decoded and had CPU landmarks. Native 320 is strongest, 256 remains close, 128 softens and 64 clearly degrades; upscales add no captured detail. Co-resident GPU load changed, so run-speed differences are not attributed to source resolution.

September 17 source-detail isolation: [fixed 512×512/25-FPS 307/256/128/64-pixel source matrix](../../benchmarks/source_detail_20260917/README.md). Four fresh BF16/four-step GPU runs on RTX 4070 SUPER, 12,282 MiB, driver 595.84, Torch 2.7.1+cu128/CUDA 12.8 with OmniVoice resident; all 1,000 frames decoded and had CPU landmarks. 307 and 256 are visually similar; 128 visibly softens detail; 64 strongly degrades the face. Generation remains 22.1–22.4 FPS because output work is fixed. This establishes harm from insufficient source detail, not benefit from native source detail above 307 pixels.

September 17 square-resolution matrix: [512/1024 at 15/25 FPS, four videos and lossless frames](../../benchmarks/square_teeth_20260917/README.md). Fresh RTX 4070 SUPER inference, 12,282 MiB visible, driver 595.84, Torch 2.7.1+cu128/CUDA 12.8, OmniVoice resident. All four BF16/four-step/eager/staged runs completed; 800 frames decoded. 1024 develops severe facial blur at both FPS values; 512 retains much better detail. Timings are single-state eager/offload results, not compiled concurrency capacity. The 1024 geometry override is restricted to the experiment process.

September 17 teeth validation: [retained 15/25-FPS 1.25× comparison](../../benchmarks/closer_capacity_20260916/TEETH_VALIDATION_20260917.md). CPU analysis detects landmarks in all 650 speech frames from prior RTX 4070 SUPER (12,282 MiB, driver 595.84, Torch 2.7.1+cu128/CUDA 12.8) clips. Audio-aligned samples support worse dental definition in several 15-FPS receiver moments, but broad edge metrics do not establish teeth sharpness and multiple settings confound FPS attribution. No new SoulX inference.

September 16 closer-face follow-up: [1.25× Indian-male five-stream run](../../benchmarks/closer_capacity_20260916/README.md), on RTX 4070 SUPER, 12,282 MiB, driver 595.84, Torch 2.7.1+cu128/CUDA 12.8; OmniVoice resident, 2,487 MiB device use before loading. Five ten-second turns completed with zero video underruns, one 20-ms audio hold, transport/cleanup pass and a fully decoded receiver recording. [Quantization/TensorRT feasibility](QUANTIZATION_TENSORRT_2026-09-16.md) is a source/evidence audit, not a new quantized or TRT engine test.

September 16 direct 15-FPS concurrency qualification: [run report and raw evidence](../../benchmarks/concurrency_15fps_20260916/README.md). Fresh local GPU inference plus WebRTC receivers ran on **NVIDIA GeForce RTX 4070 SUPER, 12,282 MiB visible**, driver 595.84, Torch 2.7.1+cu128 / CUDA 12.8, with a co-resident OmniVoice process using about 2,478 MiB before SoulX. At 320×576/four steps/BF16 resident weights, experimental GPU batch five delivered five active 15-FPS streams with zero video underruns in a 15-turn soak; three isolated 20-ms audio holds remain. Six streams failed with 132 video underruns. Four is the conservative operational limit; five is the measured local video ceiling. The receiver MP4, snapshots, full timestamp evidence and 200-ms GPU samples are retained. CPU regressions after adding the opt-in batch-five choice: **72 passed / one skipped**; an initial invocation without `PYTHONPATH=.` failed collection and is not a product failure.

Earlier September 16 read-only runtime/benchmark investigation: [head-motion controls](HEAD_MOTION_CONTROL_2026-09-16.md) and [concurrency potential versus MuseTalk](CONCURRENCY_POTENTIAL_2026-09-16.md). Fresh CPU landmark analysis detects all 1,500 frames in six prior clips generated on RTX 4070 SUPER, 12,282 MiB visible, driver 595.84, Torch 2.7.1+cu128 / CUDA 12.8. Historical RTX 4070 and MuseTalk V100/3090/4090/5000 Ada/6000 Ada records retain separate attribution. That phase added source inspection and CPU arithmetic; the later direct capacity run above supplies the new GPU load evidence and service change.

September 16 Ditto 0.7 follow-up: [three-framing 0.7 experiment](../../benchmarks/distance_lipsync/DITTO_CLOSER_0P7_REPORT.md) and [model-choice/framing interpretation](MODEL_CHOICE_AND_FRAMING_2026-09-16.md). Fresh offline GPU inference on NVIDIA GeForce RTX 4070 SUPER, 12 GB class / 12,282 MiB visible, driver 595.84; Torch 2.5.1+cu121 / CUDA 12.1. Direct `results.json` records 2,487 MiB pre-load allocation, workload identity unverified. Three 250-frame clips, three retained silent intermediates, and two composites fully decoded. Mean normalized mouth opening increases 37.4–39.5% versus 0.5, but framing correlations remain 0.995/0.993. CPU analysis is not a hardware benchmark; naturalness and phoneme accuracy remain unscored. User preference for SoulX does not override historical production acceptance gates.

September 16 Ditto replication: [three close framings at `vad_alpha=0.5`](../../benchmarks/distance_lipsync/DITTO_CLOSER_0P5_REPORT.md). Fresh GPU inference on NVIDIA GeForce RTX 4070 SUPER, 12,282 MiB visible, driver 595.84; Torch 2.5.1+cu121 / CUDA 12.1. Three 250-frame videos and a labeled composite fully decoded; all 750 frames had landmarks. Mouth-trajectory correlations with 1.00× were 0.991/0.988. This is offline framing evidence, not a phoneme-accuracy or serving qualification.
...
September 16 framing/strength follow-up: [distance and framing experiments](../../benchmarks/distance_lipsync/README.md). The Indian male was tested at 1.00×/1.25×/1.50× framing, first unmodified and then under the process-local strength-0.5 audio cross-attention hook. The requested strength-0.5 comparison contains three 250-frame clips; all raw hashes differ from unmodified controls and all 750 frames have landmarks. The 1.25× pose best preserves its unmodified trajectory (0.928 correlation) while reducing p95 opening 24.6%. This is offline GPU inference, not WebRTC qualification or a production default.
...
September 13 male teeth-quality follow-up: [controlled four-profile test](MALE_TEETH_QUALITY_2026-09-13.md). Twenty-four renders (two seeds × three repeats × BF16/INT8 at 320×576/384×672), pixel-identical repeats, eight raw clips and eight real local WebRTC receiver captures. BF16 also shows the teeth defect; neither tested precision/resolution change earns an anatomical quality pass. Original live service restored. Evidence retained locally under `/workspace/experiments/flashhead-male-quality-nsgv5L`.

September 13 update: [full media optimization test report](MEDIA_OPTIMIZATION_2026-09-13.md) and [raw summary](../../benchmarks/media_20260913/summary.json). **72 passed / one skipped** CPU regressions; 303 cached/legacy idle frames match exactly; retained baseline/intermediate failures; two selected ten-connected/one-speaker H264 rounds at 250.07/249.88 aggregate wire FPS with zero/two underruns (not strict smoothness passes). Final single-call WebRTC MP4: 945 frames, 24.98 FPS, zero underruns, one missed slot, pacing/structural checks and all nine sender boundary checks passed. Sparse visual review found no obvious corruption, not proof of artifact-free generation. Existing historical results below remain unchanged.

September 11 update: [pipeline profiling and live-avatar report](PIPELINE_PROFILE_2026-09-11.md) records 72 measured GPU renders, retained failed/successful layout trials, four individual-avatar call tests, a ten-connected/one-speaker smoothness failure, CPU idle controls, and **63 passed / one skipped** final regressions. Raw evidence: `/workspace/experiments/flashhead-pipeline-ARsFTh`; reproducible drivers: `benchmarks/pipeline_20260911/`. This addendum does not replace the historical results below.
