"""Build the labeled LITE-vs-PRO A/B video and validate both generated media files."""
import json
import subprocess
...
def main():
    output = ROOT / "soulx-LITE-vs-PRO-indian-man-1.50x-320x576-seed50-recreated.mp4"
    command = [
        ...
        "-pix_fmt", "yuv420p", "-c:a", "aac", "-t", "10.0", str(output),
    ]
